...
%Anmerkung
\newcommand{\anmerkung}[1]{\textcolor{red}{#1}}
...
\begin{document}
	...
	\begin{figure}[h!]
		\begin{subfigure}[c]{0.5\textwidth}
			...
			\subcaption{Gesamter Versuchsaufbau}
		\end{subfigure}
	\begin{subfigure}[c]{0.5\textwidth}
		\centering
		\includegraphics[width=0.5\textwidth]{img/Thermostat_Logging}
		\captionsetup{labelformat=empty}
		\subcaption{Computer mit \textsc{Julabo Easy Temp}}
	\end{subfigure}
	...
	\begin{figure}[h!]
		\begin{subfigure}[c]{0.5\textwidth}
			...
			\captionsetup{labelformat=empty}
			\subcaption{Thermostat}
		\end{subfigure}
		\begin{subfigure}[c]{0.5\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth, angle=-90]{img/Thermostat_Anschluss}
			\captionsetup{labelformat=empty}
			\subcaption{Thermostatanschlüsse}
		\end{subfigure}
	\end{figure}
	\FloatBarrier
	...
	\begin{figure}[h!]
		\begin{subfigure}[c]{0.5\textwidth}
			...
			\captionsetup{labelformat=empty}
			\subcaption{Reaktor mit Laborrührer}
		\end{subfigure}
		\begin{subfigure}[c]{0.5\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{img/Ankerruehrer}
			\captionsetup{labelformat=empty}
			\subcaption{Zur Verfügung stehende Rührer}
		\end{subfigure}
	\end{figure}
	\FloatBarrier
		...
		\begin{subfigure}[c]{0.5\textwidth}
			...
			\captionsetup{labelformat=empty}
			\subcaption{\textsc{Ismatec} Zahnrradpumpe}
		\end{subfigure}
		\begin{subfigure}[c]{0.5\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth, angle=-90]{img/Prominent}
			\captionsetup{labelformat=empty}
			\subcaption{Magnet-Membranpumpe \textsc{ProMinent beta/5}}
		\end{subfigure}
	\end{figure}
	\FloatBarrier
